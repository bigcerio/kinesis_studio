...
export interface Exercise {
  ...
  /** "search": nessun video verificato, solo link di ricerca. "youtube": video specifico embeddabile. "custom": video caricato dallo studio. */
  videoSource: "search" | "youtube" | "custom";
  /** ID video YouTube (per videoSource "youtube") oppure URL del file proprio (per "custom"). */
  videoId?: string;
  videoUrl: string;
